...
local Notify = loadstring(game:HttpGet("https://raw.githubusercontent.com/SmallCAt333/smallcattail/refs/heads/gh-pages/Notification.lua"))() 
local instance = {obj = {}}
...
local function wl(key)
    ...
    if sign_match == decode_response.sign then
        ...
        local Fluent = loadstring(game:HttpGet("https://github.com/SmallCAt333/smallcattail/blob/gh-pages/main.lua"))()
        repeat
            task.wait()
