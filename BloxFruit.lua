local redzlib = loadstring(game:HttpGet("https://github.com/SmallCAt333/smallcattail/blob/gh-pages/BloxFruit.lua"))()
local Window = redzlib:MakeWindow({
  Title = "CrazySea : Blox Fruits",
  SubTitle = "by ECC",
  SaveFolder = "ECC Hub | Blox Fruits.lua"
})
...
Discord:AddDiscordInvite({
  Name = "ECC Hub | Community",
  Description = "Join our discord community to receive information about the next update",
  Logo = "rbxassetid://15298567397",
  Invite = "https://discord.gg/RnyBmcf4"
})
